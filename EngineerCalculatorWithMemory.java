 ...
 */
public class EngineerCalculatorWithMemory implements Calculator {
    ...
    public double calculate(List<String> list) {
        ...
        for(int i = 1;i<list.size();i++)
        {
            ...
            else if (operations.Engineeroperations.containsKey(list.get(i)))
            {
                result = operations.Engineeroperations.get(list.get(i)).doOperation(result,0);
            }
